...
namespace RestaurantApplication
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<RestaurentDBContext>(db => db.UseSqlServer(Configuration.GetConnectionString("ConRest")));
            ...
            services.AddTransient<IItems,ItemsRL>();
            services.AddTransient<IOrderItemBL, OrderItemBL>();
            services.AddTransient<IOrderItemRL, OrderItemRL>();
            services.AddTransient<IAddrssBL,AddressBL>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "RestaurantApplication"));
            }
